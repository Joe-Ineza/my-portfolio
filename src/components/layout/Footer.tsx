                ...
                return (
                  <li key={social.label}>
                    <a
                      ...
                      className="text-gray-500 hover:text-gray-900 transition-colors p-2.5 rounded-xl hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
